...
# modified from diffusers/models/vae.py
class VectorQuantizer(nn.Module):
    def __init__(
        self, n_e, vq_embed_dim, beta, remap=None, unknown_index="random", sane_index_shape=False,
    ):
        super().__init__()
        self.n_e = n_e
...
# modified from diffusers/models/vq_model.py
